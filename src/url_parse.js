...
function parseURL(url) {
    return __awaiter(this, void 0, void 0, function () {
        var splitStr, gitIdx, npmIdx, packageName, repoUrl, response, data, i;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    splitStr = url.split("/");
                    gitIdx = splitStr.indexOf("github.com");
                    if (!(gitIdx > -1)) return [3 /*break*/, 1];
                    return [2 /*return*/, [splitStr[gitIdx + 1], splitStr[gitIdx + 2]]]; // return owner and repo name
                case 1:
                    npmIdx = splitStr.indexOf("www.npmjs.com");
                    if (!(npmIdx > -1)) return [3 /*break*/, 4];
                    packageName = splitStr[npmIdx + 2];
                    repoUrl = "";
                ...
                case 3:
                    ...
                    if (gitIdx > -1) // NPM link hosts github
                     {
                        return [2 /*return*/, [splitStr[gitIdx + 1], splitStr[gitIdx + 2].replace(".git", "")]]; // return owner and repo name with removed .git
                    }
                    _b.label = 4;
                case 4: return [2 /*return*/, ["", ""]]; // ERROR INVALID LINK
            }
        });
    });
}

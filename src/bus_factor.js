...
function getBusFactor(owner, repoName) {
    return __awaiter(this, void 0, void 0, function () {
        var start, query, response, edges, dict, max, i, userName, score, elapsed_time;
            ...
            switch (_k.label) {
                ...
                case 1:
                    ...
                    for (i = 0; i < edges.length; i++) {
                        userName = (_j = (_h = (_g = (_f = edges[i]) === null || _f === void 0 ? void 0 : _f.node) === null || _g === void 0 ? void 0 : _g.author) === null || _h === void 0 ? void 0 : _h.user) === null || _j === void 0 ? void 0 : _j.login;
                        if (userName in dict) {
                            dict[userName]++;
                    ...
                    score = 1 - 1.02 * Math.pow((0.01 - (max / 100)), 2);
                    elapsed_time = (new Date().getTime() - start) / 1000;
                    logger_1.default.infoDebug("Successfully calculated Bus Factor of ".concat(score, " for ").concat(owner, "/").concat(repoName, " in ").concat(elapsed_time, "s"));
